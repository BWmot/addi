...
const en: I18nMessages = {
  ...
  provider: {
    ...
    defaultModelSettingsDesc:
      'Defaults inherited by all models. Can be overridden per model.',
    ...
    thinkingHintMap: {
      'openai-responses':
        'OpenAI (Responses API): maps to reasoningEffort parameter.',
      'openai-completions':
        'OpenAI-compatible (DeepSeek, MiMo, etc.): passed as reasoning effort.',
      'anthropic-messages':
        'Anthropic: Low→1024, Medium→4096, High→8192 budget tokens.',
      'google-generateContent':
        'Google: maps to thinkingConfig.thinkingLevel.',
    ...
    experimentalDesc:
      'Experimental. Test thoroughly before using in production.',
  ...
  model: {
    ...
    thinkingHintMap: {
      ...
      'google-generateContent':
        'Google: maps to thinkingConfig.thinkingLevel for Gemini models.',
    } as Record<string, string>,
